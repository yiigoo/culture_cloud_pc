<template>
    <div>
        ...
        <div class="page-container">
                ...
                <div class="left-md pull-left">
                    ...
                    <div class="flex-table">
                        <div class="item">
                            ...
                            <div class="value">叙州区某某路某某号某某地区一楼叙州区某某路某叙州区某某路某叙州区某某路某</div>
                        </div>
                        <div class="item">
                            <div class="label">活动时间：</div>
                            <div class="value">2020/11/13 - 2020/11/25</div>
                        </div>
                        <div class="item">
                        ...
                        <div class="item">
                            ...
                            <div class="value">叙州区文化馆、叙州区图书馆、叙州区文化馆、叙州区图书馆、叙州区文化馆、叙州区图书馆</div>
                        </div>
                        <div class="item">
                            <div class="label">报名人数：</div>
                            <div class="value">300人</div>
                        </div>
                    </div>
            ...
            <div class="clearfix">
                <div class="page-content pull-left">
                     <div class="page-tabs">
                        <div class="item" 
                            @click="tabsActive = '1'" :class="{ active: tabsActive === '1'}">
                            场馆介绍
                        </div>
                        <div class="item" 
                            @click="tabsActive = '2'" :class="{ active: tabsActive === '2'}">
                            群文活动
                        </div>
                        <div class="item" 
                            @click="tabsActive = '3'" :class="{ active: tabsActive === '3'}">
                            培训辅导
                        </div>
                        <div class="item" 
                            @click="tabsActive = '4'" :class="{ active: tabsActive === '4'}">
                            文艺团队
                        </div>
                    </div>
                    <div class="page-content-wrapper">

                        <div class="editor" v-if="tabsActive === '1'">
                        ...
                        <div v-if="tabsActive === '2'">
                            <pager-rows ref="rows" request="" :pageSize="5">
                                <template v-slot="slotProps">
                                    <div class="figure-list">
                                        <div class="item" v-for="item in 5" :key="item">
                                            <div class="img imgx200">
                                                <a href="">
                                                    <img src="../../assets/temp/102.png" alt="">
                                                </a>
                                            </div>
                                            <div class="wrapper">
                                                <div class="title">
                                                    <a href="">活动标题活动标题活动标题活动标题活动标题活动标题活动标题活动标题活动标题</a>
                                                </div>
                                                <div class="sub">
                        ...
                        <div class="" v-if="tabsActive === '3'">
                        </div>

                        <div class="" v-if="tabsActive === '4'">
                        </div>
                    </div>
                    <share-bar></share-bar>
        ...
        <Modal
            ...
            closable
            title="现在提交申请吗？">
            <p class="text-center">我们将根据你提交的信息进行审核，请及时查看报名信息。</p>
            <div slot="footer">
                <Button class="mr20" @click="modalVisible = false">取消</Button>
                <Button class="border-primary" @click="submit">确定</Button>
            </div>
        </Modal>
    </div>
</template>
