            ...
            <div class="clearfix">
                <div class="page-aside">
                    <div class="page-menu">
                        ...
                        <div class="list">
                            <ul>
                                <li><router-link to="/culture-team/list">社团</router-link></li>
                                <li><router-link to="/culture-team/art">名师</router-link></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="page-content">
                    <div class="page-swiper page-swiper-detail">
                        <swiper ref="mySwiperTop" :options="swiperOptionTop">
							<swiper-slide>
								<div class="item">
									<img src="../../assets/temp/906.png" alt="">
								</div>
							</swiper-slide>
							<swiper-slide>
								<div class="item">
                    ...
                    <div class="page-detail">
                        <div class="detail-wrapper">
                            ...
                            <div class="sub">
                                时间：2020-10-20 来源：叙州文化馆 阅读：201
                            </div>
                            <div class="flex-table border-bottom mb20">
                                <div class="item">
